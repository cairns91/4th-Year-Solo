...
public class Bank_Coverage_Tests_3 {

	public static void Pair2a4a_3() {
		int lastIndex = 0;
		int firstIndex = 0;
		int secondIndex = 0;
		...
		for (int i = 0; i < Bank_Coverage_SharedResources.B_syncLocations.size(); i++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(i).equals("3 Th1 getBalance")) {
				lastIndex = i;
				firstIndex = i;
		...
		for (; lastIndex < Bank_Coverage_SharedResources.B_syncLocations.size(); lastIndex++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex).equals("3 Th1 withdraw")) {
	...
	public static void Pair2a2b_3() {
		...
		for (; lastIndex < Bank_Coverage_SharedResources.B_syncLocations.size(); lastIndex++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex).equals("3 Th2 getBalance")) {
				secondIndex = lastIndex;
				location2 = Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex);
			}
		}
	...
	public static void Pair2a4b_3() {
		...
		for (; lastIndex < Bank_Coverage_SharedResources.B_syncLocations.size(); lastIndex++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex).equals("3 Th2 withdraw")) {
				secondIndex = lastIndex;
				location2 = Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex);
			}
		}
	...
	public static void Pair4a2a_3() {
		...
		for (int i = 0; i < Bank_Coverage_SharedResources.B_syncLocations.size(); i++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(i).equals("3 Th1 withdraw")) {
				lastIndex = i;
				firstIndex = i;
				location1 = Bank_Coverage_SharedResources.B_syncLocations.get(i);
			}
		...
		for (; lastIndex < Bank_Coverage_SharedResources.B_syncLocations.size(); lastIndex++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex).equals("3 Th1 getBalance")) {
				secondIndex = lastIndex;
				location2 = Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex);
			}
		}
	...
	public static void Pair2b4b_3() {
		...
		for (int i = 0; i < Bank_Coverage_SharedResources.B_syncLocations.size(); i++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(i).equals("3 Th2 getBalance")) {
				lastIndex = i;
				firstIndex = i;
				location1 = Bank_Coverage_SharedResources.B_syncLocations.get(i);
			}
	...
	public static void Pair4b2b_3() {
		...
		for (int i = 0; i < Bank_Coverage_SharedResources.B_syncLocations.size(); i++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(i).equals("3 Th2 withdraw")) {
				lastIndex = i;
				firstIndex = i;
				location1 = Bank_Coverage_SharedResources.B_syncLocations.get(i);
			}
	...
	public static void Pair2a6a_3() {
		...
		for (; lastIndex < Bank_Coverage_SharedResources.B_syncLocations.size(); lastIndex++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex).equals("3 Th1 deposit")) {
				secondIndex = lastIndex;
				location2 = Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex);
			}
		}
	...
	public static void Pair2a6b_3() {
		...
		for (; lastIndex < Bank_Coverage_SharedResources.B_syncLocations.size(); lastIndex++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex).equals("3 Th2 deposit")) {
				secondIndex = lastIndex;
				location2 = Bank_Coverage_SharedResources.B_syncLocations.get(lastIndex);
			}
		}
	...
	public static void Pair6a2a_3() {
		...
		for (int i = 0; i < Bank_Coverage_SharedResources.B_syncLocations.size(); i++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(i).equals("3 Th1 deposit")) {
				lastIndex = i;
				firstIndex = i;
				location1 = Bank_Coverage_SharedResources.B_syncLocations.get(i);
			}
	...
	public static void Pair6b2b_3() {
		...
		for (int i = 0; i < Bank_Coverage_SharedResources.B_syncLocations.size(); i++) {
			if (Bank_Coverage_SharedResources.B_syncLocations.get(i).equals("3 Th2 deposit")) {
				lastIndex = i;
				firstIndex = i;
				location1 = Bank_Coverage_SharedResources.B_syncLocations.get(i);
			}
